            ...
            <form method="post" data-parsley-validate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step=".01" name="share_percentage" autocomplete="off"
                            class="form-control p-4  " max="100" min="1"
                        ...
                        <input type="number" step=".01" name="share_percentage_you" autocomplete="off"
                            class="form-control p-4  " max="100" min="1" placeholder="Percentage (%)" readonly required>
