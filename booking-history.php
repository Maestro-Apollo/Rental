...
<body class="bg-light">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="agent_com" class="form-control" id="agent_com"
                                    placeholder="Enter agent com">
                            </div>
                            <div class="form-group">
                                <label for="city">Rent/Month</label>
                                <input type="text" class="form-control" id="rent" placeholder="Enter Rent">
                            </div>
                            <div class="form-group">
                                <label for="city">CL</label>
                                <input type="number" name="land_com" class="form-control" id="com_landlord"
                                    placeholder="Enter L.C">
                            </div>
                            <div class="form-group">
                                <label for="city">CT</label>
                                <input type="number" name="tenant_com" class="form-control" id="com_tenant"
                                    placeholder="Enter T.C">
                            </div>
                            <div class="form-group">
                                <label for="city">ACL</label>
                                <input type="number" name="agent_com_per" class="form-control" id="agent_com_landloard"
                                    placeholder="Enter ACL" readonly>
                            </div>
                            <div class="form-group">
                                <label for="city">ACT</label>
                                <input type="number" name="tenant_com_per" class="form-control" id="agent_com_tenant"
                                    placeholder="Enter ACT" readonly>
                            </div>
                            <div class="form-group">
                                <label for="city">TAC</label>
                                <input type="number" class="form-control" name="company_com" id="company_com"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="admin_comment" id="admin_comment"
                                    placeholder="Admin Comment" readonly cols="30" rows="3"></textarea>

                            </div>
                            <div class="form-group">
                                <label for="city">Staff Comment</label>
                                <textarea class="form-control" name="staff_comment" id="staff_comment"
                                    placeholder="Staff Comment" cols="30" rows="3"></textarea>

                            </div>
                            <input type="hidden" autocomplete="off" class="form-control mt-4 p-4  bg-light" id="tcc"
                                name="tcc" placeholder="TCC" required readonly>
    ...
    $('#btn_save').click(function() {
        ...
        var tcc = $('#tcc').val().trim();
        var admin_comment = $('#admin_comment').val().trim();
        var staff_comment = $('#staff_comment').val().trim();

        if (property_name != '' && date != '' && agent_com != '' && rent != '' && com_landlord != '' &&
            com_tenant != '' && agent_com_landloard != '' && agent_com_tenant != '' && company_com != '' &&
            tcc != '') {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 1) {
                        ...
                        // Empty the fields
                        $('#property_name', '#date', '#agent_com', '#rent', '#com_landlord',
                            '#com_tenant', '#agent_com_landloard', '#agent_com_tenant',
                            '#company_com', '#tcc', '#admin_comment', '#staff_comment').val('');
                        $('#txt_userid').val(0);
